...
This algorithm is implemented in the Sat4J library under the designation $IBB$, except that prime implicants are used instead of models. For specifics on that see chapter \ref{ss:primeImplicant}. 
