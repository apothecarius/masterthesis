...
You could argue that $BB$ (see algorithm \ref{alg:bb}) matches this concept, since it reduces the set of literals to further examine with every found model. It removes both the identified backbone literals and the found models from the set of literals to test and once that becomes empty, it terminates.
